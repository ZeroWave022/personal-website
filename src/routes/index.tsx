        ...
        <>
                    ...
                    {experienceList.map((item) => (
                        ...
                        >
                            ...
                            <div className="p-2 text-center dark:text-slate-200">
                                {t("index.skills.duration", { count: item.duration })}
                            </div>
                        </div>
                    ))}
                </div>
            ...
            <section id="projects" className="mdh:h-screen snap-start snap-always">
                <h1>
                    <Trans i18nKey="index.projects.title1">
                        Project 1: <span className="dark:text-white">Discover</span> <span className="text-green-600 dark:text-emerald-500">Poland</span>
                    </Trans>
                </h1>
                <div className="flex flex-col justify-center items-center gap-5 m-5 md:flex-row">
                    <div className="flex flex-col gap-8 justify-center items-center">
                        ...
                        <p>
                            {t("index.projects.techUsed", { tech: ["Next.js", "React"] })}
                        </p>

                        <LargeLink color="green-light" link="https://discoverpoland.netlify.app">
                            {t("common.visit", { destination: "Discover Poland" })}
                        </LargeLink>
                    </div>
            ...
            <section className="mdh:h-screen snap-start snap-always">
                ...
                <div className="flex flex-col justify-center items-center gap-5 m-5 md:flex-row">
                    <div className="flex flex-col gap-8 justify-center items-center">
                        <p>
                            {t("index.projects.description2")}
                        </p>
                        <p className="m-0">
                            {t("index.projects.techUsed", { tech: ["Flask (Python)", "PostgreSQL", "chart.js"] })}
                        </p>
                    ...
                    <a className="w-[90vw] md:max-w-[45vw] overflow-hidden inline-block rounded-md p-5 bg-[#e4dccf] cursor-pointer" href="https://github.com/ZeroWave022/MusicVision" target="_blank" rel="noreferrer">
                        <img className="w-full hover:scale-[102%] transition duration-700 ease-in-out" src={musicvision} alt="MusicVision" />
                    </a>
                </div>
            </section>
